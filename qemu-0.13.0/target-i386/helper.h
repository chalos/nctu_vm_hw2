...
// DEBUG
DEF_HELPER_FLAGS_1(print_line, TCG_CALL_CONST, void, int)
DEF_HELPER_FLAGS_2(print_linereg, TCG_CALL_CONST, void, int, tl)
DEF_HELPER_FLAGS_2(get_return, TCG_CALL_CONST, ptr, env, tl)
